...
const FloatingWhatsApp = () => {
    return (
        <a
            ...
            onClick={(e) => {
                e.preventDefault();
                alert('[ MODO DEMONSTRAÇÃO ]\n\nNa versão ativa para o escritório, este botão abrirá diretamente o WhatsApp com mensagem pré-configurada para agendamento de consulta.');
        ...
        >
            {/* Tooltip */}
            <div className="absolute right-[115%] bg-white text-dark font-sans text-sm px-4 py-2 rounded-xl shadow-[0_4px_15px_rgba(0,0,0,0.1)] whitespace-nowrap opacity-0 pointer-events-none group-hover:opacity-100 group-hover:-translate-x-2 transition-all duration-300 border border-black/5 hidden md:block">
