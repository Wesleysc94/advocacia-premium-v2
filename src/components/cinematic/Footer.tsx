            ...
            <div className="max-w-4xl mx-auto flex flex-col items-center text-center gap-5 mb-12 border-b border-white/10 pb-12 mt-4">
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-4 w-full justify-center max-w-xl">
                    <button
                        ...
                        className="group relative w-full sm:w-1/2 overflow-hidden bg-gold text-dark px-8 py-4 rounded-[2.5rem] font-sans text-base font-bold hover:scale-105 transition-transform duration-300 shadow-[0_0_20px_hsl(var(--gold)/0.3)] flex justify-center"
                    >
                    ...
                    <button
                        ...
                        className="group relative w-full sm:w-1/2 overflow-hidden bg-[#25D366] text-white px-8 py-4 rounded-[2.5rem] font-sans text-base font-bold hover:scale-105 transition-transform duration-300 shadow-[0_0_20px_rgba(37,211,102,0.4)] flex justify-center"
                    >
